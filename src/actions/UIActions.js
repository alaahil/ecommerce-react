...
export const checkoutSetDeliveryTime = (payload) => ({
  type: MAGENTO_SET_DELIVERY_TIME,
  payload,
});

export const checkoutSetDeliveryDate = (payload) => ({
  type: MAGENTO_SET_DELIVERY_DATE,
  payload,
});
...
export const setCustomerAccountInfoBoolean = (isInfoSet) => ({
  type: MAGENTO_SET_CUSTOMER_ACCOUNT_INFO,
  payload: isInfoSet,
});

export const setCustomerPaymentInfoBoolean = (isInfoSet) => ({
  type: MAGENTO_SET_CUSTOMER_PAYMENT_INFO,
  payload: isInfoSet,
});

export const setCustomerShippingInfoBoolean = (isInfoSet) => ({
  type: MAGENTO_SET_CUSTOMER_SHIPPING_INFO,
  payload: isInfoSet,
});
