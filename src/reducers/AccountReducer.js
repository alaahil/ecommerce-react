...
export default (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case MAGENTO_ACCOUNT_SET_USER_EMIRATES: {
      return { ...state, store: { ...state.store, emirates: action.payload } };
    }
    ...
    case MAGENTO_ADD_NEW_ADDRESS_ERROR: {
      return {
        ...state,
        ui: { ...state.ui, loading: false, error: action.payload },
      };
    }
    case MAGENTO_ADD_New_ADDRESS: {
      return {
        ...state,
        customer: action.payload,
        ui: { ...state.ui, loading: false, error: false },
